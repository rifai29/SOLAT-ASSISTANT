...
export function MotivationCard({ quote, isLoading }: MotivationCardProps) {
  return (
    ...
    >
      <div className="bg-card border border-accent/10 p-8 rounded-2xl relative overflow-hidden group flex items-center gap-6">
        <div className="w-16 h-16 rounded-full border border-accent/20 flex items-center justify-center shrink-0">
